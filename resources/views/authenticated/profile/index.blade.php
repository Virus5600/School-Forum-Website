...
<div class="row gap-3 gap-md-0">
	...
	<div class="col-12 col-md-3 position-relative">
		<div class="sticky-md-top d-flex flex-column gap-5 mh-100 overflow-auto" style="top: calc(1rem + var(--navbar-height));">
			{{-- Profile Navigation --}}
			<div class="card floating-header">
				<h4 class="card-header header-center header-md-start border rounded bg-white">Profile Navigation</h4>
			...
			{{-- Account Settings --}}
			<div class="card floating-header">
				<h4 class="card-header header-center header-md-start border rounded bg-white">Account Settings</h4>

				<div class="card-body p-0">
					<nav class="list-group list-group-flush rounded">
						<a href="{{ route('profile.change-password.edit') }}" class="list-group-item list-group-item-action">Update Password</a>
						<a href="{{ route('profile.deactivate') }}" class="list-group-item list-group-item-action">Deactivate Account</a>
					</nav>
				</div>
			</div>
			<hr class="sr-only">
		...
		<div class="container-fluid">
			...
			<section class="card floating-md-header border-0 bg-transparent mt-6">
				...
				<div class="card-body">
					...
					<div class="d-flex flex-column my-3 p-3 rounded" id="personal-information">
					...
					{{-- ACCOUNT INFORMATION --}}
					<div class="d-flex flex-column my-3 p-3 rounded" id="account-information">
