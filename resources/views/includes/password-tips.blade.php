<div class="alert alert-info alert-dismissible w-100 w-md-auto position-absolute top-0 start-50 translate-middle-x start-md-0 translate-md-start m-md-3 ms-md-0 d-flex align-items-center z-3 rounded-end-md-pill fade {{ isset($alertAdditionalClass) ? $alertAdditionalClass : '' }}" role="alert" id="password-tips" style="left: -100% !important;">
