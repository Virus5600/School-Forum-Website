<div class="sidebar collapse-horizontal text-bg-dark shadow-lg w-lg-auto" id="sidebar" aria-labelledby="sidebar-toggler" aria-expanded="false" data-bs-theme="dark">
	...
	<div class="sidebar-content d-flex flex-column py-3 px-0 overflow-y-auto bg-it-primary">
		...
		<a class="text-decoration-none bg-it-secondary aria-link" href="{{ route('admin.dashboard') }}" aria-hidden="false" aria-label="Dashboard"><i class="fas fa-tachometer-alt me-2 col-2"></i>Dashboard</a>
		@else
		...
		<a class="text-decoration-none bg-it-secondary aria-link" href="{{ route('admin.lost-and-found.index') }}" aria-hidden="false" aria-label="Items"><i class="fa fa-box-open me-2 col-2"></i>Lost and Found</a>
		@else
		<a class="text-decoration-none aria-link" href="{{ route('admin.lost-and-found.index') }}" aria-hidden="false" aria-label="Items"><i class="fa fa-box-open me-2 col-2"></i>Lost and Found</a>
		@endif
		...
		<a class="text-decoration-none bg-it-secondary aria-link" href="@{{ route('admin.users.index') }}" aria-hidden="false" aria-label="Items"><i class="fa fa-users me-2 col-2"></i>Users</a>
		@else
		...
		<a class="text-decoration-none bg-it-secondary aria-link" href="@{{ route('admin.user-types.index') }}" aria-hidden="false" aria-label="Items"><i class="fa fa-circle-user me-2 col-2"></i>User Types</a>
		@else
		...
		<a class="text-decoration-none bg-it-secondary aria-link" href="@{{ route('admin.permissions.index') }}" aria-hidden="false" aria-label="Items"><i class="fa fa-lock me-2 col-2"></i>Permissions</a>
		@else
		...
		<a class="text-decoration-none bg-it-secondary aria-link" href="@{{ route('admin.activity-log.index') }}" aria-hidden="false" aria-label="Items"><i class="fa fa-book me-2 col-2"></i>Activity Log</a>
		@else
		...
		<a class="text-decoration-none bg-it-secondary aria-link" href="@{{ route('admin.settings.index') }}" aria-hidden="false" aria-label="Items"><i class="fa fa-gear me-2 col-2"></i>Settings</a>
		@else
