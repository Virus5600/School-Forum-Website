...
<p>To access your account, go to the <a href="{{ route('login') }}">login</a> page and enter the credentials along with the verification code below:</p>

<code style="font-size: large;">
	<span style="font-family: Arial;">Email:</span> {{ $args['email'] }}<br>
	<span style="font-family: Arial;">Password:</span> {{ $args['password'] }}<br>
	<span style="font-family: Arial;">Verification Code:</span> {{ $args['code'] }}
</code>
@endsection
